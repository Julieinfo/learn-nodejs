...
- Créer un serveur REST from scratch avec Node.js et Express
- Modéliser des données avec Mongoose et interagir avec MongoDB
- Sécuriser une API avec JWT (inscription, connexion, middleware)
- Gérer l'upload et la suppression de fichiers côté serveur
- Organiser un projet back-end en routes / controllers / models
